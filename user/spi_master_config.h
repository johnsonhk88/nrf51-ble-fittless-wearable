...
#define SPI_PSELSCK0             SPI0_SCK   /*!< GPIO pin number for SPI clock (note that setting this to 31 will only work for loopback purposes as it not connected to a pin) */
#define SPI_PSELMOSI0            SPI0_MOSI  /*!< GPIO pin number for Master Out Slave In    */
#define SPI_PSELMISO0            SPI0_MISO   /*!< GPIO pin number for Master In Slave Out    */
#define SPI_PSELSS0              SPI0_SS  /*!< GPIO pin number for Slave Select           */
