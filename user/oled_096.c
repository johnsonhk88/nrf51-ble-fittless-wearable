/*****************************************************************
0.96 inches OLED driver for SSD1306 ic
...
/*Global varible*/
  uint32_t *spi_base_address=NULL;
volatile uint8_t spi0_tx_data[TX_RX_MSG_LENGTH]; /**< SPI TX buffer. */
volatile uint8_t spi0_rx_data[TX_RX_MSG_LENGTH]; /**< SPI RX buffer. */
