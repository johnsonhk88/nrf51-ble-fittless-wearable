...
#line 14 "..\\user\\ble_apps_uart.c"
#line 15 "..\\user\\ble_apps_uart.c"
#line 16 "..\\user\\ble_apps_uart.c"
#line 17 "..\\user\\ble_apps_uart.c"
#line 18 "..\\user\\ble_apps_uart.c"
#line 19 "..\\user\\ble_apps_uart.c"
#line 20 "..\\user\\ble_apps_uart.c"
...
#line 21 "..\\user\\ble_apps_uart.c"
#line 22 "..\\user\\ble_apps_uart.c"
#line 23 "..\\user\\ble_apps_uart.c"
#line 24 "..\\user\\ble_apps_uart.c"
#line 25 "..\\user\\ble_apps_uart.c"
...
#line 26 "..\\user\\ble_apps_uart.c"
#line 27 "..\\user\\ble_apps_uart.c"
#line 28 "..\\user\\ble_apps_uart.c"
...
static void timers_init(void)
{
  ...
  do { static uint32_t APP_TIMER_BUF[((((( (((2)) * 40) + ( 3 * (8 + (((4) + 1) + 1) * 24) ) )) - 1) / (sizeof(uint32_t))) + 1)]; uint32_t ERR_CODE = app_timer_init((0), (2), (4) + 1, APP_TIMER_BUF, (0) ? app_timer_evt_schedule : 0); do { const uint32_t LOCAL_ERR_CODE = (ERR_CODE); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 84, (uint8_t*) "..\\user\\ble_apps_uart.c"); } while (0); } } while (0); } while (0);
	 err_code = app_timer_create(&m_rtc_update_timer_id,
                                APP_TIMER_MODE_REPEATED,
                                rtc_timeout_handler);
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 88, (uint8_t*) "..\\user\\ble_apps_uart.c"); } while (0); } } while (0); 
...
static void gap_params_init(void)
{
    ...
    err_code = sd_ble_gap_device_name_set(&sec_mode,
                                          (const uint8_t *) "BLE_Health",
                                          strlen("BLE_Health"));
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 109, (uint8_t*) "..\\user\\ble_apps_uart.c"); } while (0); } } while (0);

    memset(&gap_conn_params, 0, sizeof(gap_conn_params));

    gap_conn_params.min_conn_interval = 16;
    gap_conn_params.max_conn_interval = 60;
    gap_conn_params.slave_latency     = 0;
    gap_conn_params.conn_sup_timeout  = 400;

    err_code = sd_ble_gap_ppcp_set(&gap_conn_params);
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 119, (uint8_t*) "..\\user\\ble_apps_uart.c"); } while (0); } } while (0);
}
...
static void advertising_init(void)
{
    ...
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 148, (uint8_t*) "..\\user\\ble_apps_uart.c"); } while (0); } } while (0);
}
...
static void services_init(void)
{
    ...
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 211, (uint8_t*) "..\\user\\ble_apps_uart.c"); } while (0); } } while (0);
}
...
static void on_conn_params_evt(ble_conn_params_evt_t * p_evt)
{
    ...
    if(p_evt->evt_type == BLE_CONN_PARAMS_EVT_FAILED)
    {
        ...
        do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 246, (uint8_t*) "..\\user\\ble_apps_uart.c"); } while (0); } } while (0);
    }
}
...
{
    do { app_error_handler((nrf_error), 257, (uint8_t*) "..\\user\\ble_apps_uart.c"); } while (0);
}
...
static void conn_params_init(void)
{
    ...
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 281, (uint8_t*) "..\\user\\ble_apps_uart.c"); } while (0); } } while (0);
}
...
static void advertising_start(void)
{
    ...
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 303, (uint8_t*) "..\\user\\ble_apps_uart.c"); } while (0); } } while (0);                            
    ...
    switch (p_ble_evt->header.evt_id)
    {
        ...
        case BLE_GAP_EVT_SEC_PARAMS_REQUEST:
            err_code = sd_ble_gap_sec_params_reply(m_conn_handle, 
                                                   0x00, 
                                                   &m_sec_params);
            do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 348, (uint8_t*) "..\\user\\ble_apps_uart.c"); } while (0); } } while (0);
            break;
            
        case BLE_GATTS_EVT_SYS_ATTR_MISSING:
            err_code = sd_ble_gatts_sys_attr_set(m_conn_handle, 0, 0);
            do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 353, (uint8_t*) "..\\user\\ble_apps_uart.c"); } while (0); } } while (0);
            break;
        ...
        case BLE_GAP_EVT_SEC_INFO_REQUEST:
            ...
            if (p_enc_info->div == p_ble_evt->evt.gap_evt.params.sec_info_request.div)
            {
                ...
                do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 365, (uint8_t*) "..\\user\\ble_apps_uart.c"); } while (0); } } while (0);
            }
            else
            {
                
                err_code = sd_ble_gap_sec_info_reply(m_conn_handle, 0, 0);
                do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 371, (uint8_t*) "..\\user\\ble_apps_uart.c"); } while (0); } } while (0);
            }
            break;
...
static void ble_stack_init(void)
{
    ...
    do { static uint32_t EVT_BUFFER[(((((((((sizeof(ble_evt_t) + (23))) < (0) ? (0) : ((sizeof(ble_evt_t) + (23))))) < (sizeof(uint32_t)) ? (sizeof(uint32_t)) : ((((sizeof(ble_evt_t) + (23))) < (0) ? (0) : ((sizeof(ble_evt_t) + (23))))))) - 1) / (sizeof(uint32_t))) + 1)]; uint32_t ERR_CODE; ERR_CODE = softdevice_handler_init((NRF_CLOCK_LFCLKSRC_SYNTH_250_PPM), EVT_BUFFER, sizeof(EVT_BUFFER), (0) ? softdevice_evt_schedule : 0); do { const uint32_t LOCAL_ERR_CODE = (ERR_CODE); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 428, (uint8_t*) "..\\user\\ble_apps_uart.c"); } while (0); } } while (0); } while (0);
    
    
    uint32_t err_code = softdevice_ble_evt_handler_set(ble_evt_dispatch);
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 432, (uint8_t*) "..\\user\\ble_apps_uart.c"); } while (0); } } while (0);
}
...
void power_manage(void)
{
    ...
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 443, (uint8_t*) "..\\user\\ble_apps_uart.c"); } while (0); } } while (0);
}
